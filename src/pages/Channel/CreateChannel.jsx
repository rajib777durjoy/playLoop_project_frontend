...
const CreateChannel = () => {
    ...
    const handleCreateChannel = async () => {
        ...
        try {
            const result = await useAxios.post('/api/createchannel', formData)
        ...
        <div className='w-full min-h-screen bg-[#0f0f0f] text-white flex flex-col'>
            <header className='flex justify-between items-center px-6 py-3 border-b border-gray-800'>
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-white font-bold text-xl tracking-tight '>PlayLoop</span>
                </div>
                ...
                <div className='bg-[#212121] p-6 rounded-xl w-full max-w-lg shadow-lg'>
                    ...
                    {step === 2 && (
                        <div>
                            ...
                            <button className='w-full flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 transition py-3 rounded-lg font-medium disabled:bg-gray-600' onClick={nextStep} disabled={!channelName} >Continue and Create Channel</button>
                    ...
                    {step === 3 && (
                        <div>
                            ...
                            <button className='w-full flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 transition py-3 rounded-lg font-medium disabled:bg-gray-600' onClick={handleCreateChannel} disabled={!description || !category} >{loading ? <TbLoader className='text-xl animate-spin text-black' /> : "Save and Create Channel"}</button>
